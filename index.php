...
<body class="bg-white">
    ...
    <div id="appCapsule">
        ...
        <div class="carousel-slider owl-carousel owl-theme">
            <div class="item p-2">
                <img src="assets/img/icon/logo.png" alt="alt" class="imaged w-100 square mb-4">
        ...
        <div class="carousel-button-footer">
            <div class="row">
                <div class="col-6">
                    <a href="register.php" class="btn btn-secondary btn-lg btn-block goBack">Daftar</a>
                </div>
                <div class="col-6">
                    <a href="login.php" class="btn btn-primary btn-lg btn-block">Log Masuk</a>
                </div>
            </div>
        </div>
